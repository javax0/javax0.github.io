...
It received a review from some experienced experts though.
To be exact, one expert, who has many years of professional experience developing concurrent Java applications.
...
On the other hand, its code can be a good starting point for your own implementation of similar approaches for your own experiments.